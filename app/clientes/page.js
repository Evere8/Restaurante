            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 space-y-2">
                  ...
                  <Input 
                    value={customerForm.direccion_principal}
                    onChange={(e) => setCustomerForm({...customerForm, direccion_principal: e.target.value})}
                ...
                <div className="col-span-2 flex items-center space-x-2">
                  <Checkbox 
                    checked={customerForm.acepta_marketing_whatsapp}
                    onCheckedChange={(checked) => setCustomerForm({...customerForm, acepta_marketing_whatsapp: checked})}
                  />
                  <Label>Acepta marketing por WhatsApp</Label>
                </div>
              </div>
                  ...
                  {customers.map(customer => (
                    <tr key={customer.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <div>
                          <div className="font-semibold text-gray-900">{customer.nombre}</div>
                          {customer.notas && (
                            <div className="text-xs text-gray-500 mt-1">{customer.notas}</div>
                          )}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600">
                        {customer.direccion_principal || '-'}
                      </td>
                      <td className="px-6 py-4">
                        {customer.acepta_marketing_whatsapp ? (
                          <Badge className="bg-green-100 text-green-800">Sí acepta</Badge>
                        ) : (
                          <Badge variant="outline">No acepta</Badge>
                        )}
                      </td>
